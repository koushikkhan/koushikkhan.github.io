...
![Figure: 2 Predicting target word based on context](context-window-cbow.svg)
...
The source for training such a network is given in this [colab notebook](https://colab.research.google.com/drive/1PJCyPULfcYcsUpkvPeQsu4GNsp5m3b3v?usp=sharing).
...
![Figure: 4 Predicting context based on target word](context-window-skip-gram.svg)
