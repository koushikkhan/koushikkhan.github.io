...
![Figure: 1 Word features representation](word-features.svg)
...
![Figure: 2 Finding target word based on context](context-window-cbow.svg)
...
![Figure: 3 A pseudo CBOW network](shallow-network-cbow.svg)
...
and here is the partial training set as the output,
...
The source for training such a network is given in this [colab notebook](https://colab.research.google.com/drive/16KM-Y-Ju8M_tiDZh5fN7vHDwDW3AbaxR?usp=sharing).
...
- [Colab notebook to play with the code](https://colab.research.google.com/drive/16KM-Y-Ju8M_tiDZh5fN7vHDwDW3AbaxR?usp=sharing)
