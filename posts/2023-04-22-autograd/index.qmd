...
According to the probability theory, this likelihood (equivalent to joint probability) of $Y_1=y_1, \dots, Y_N=y_N$ is product of the individual likelihoods i.e. 

\begin{align}
  P(Y_1=y_1, \dots, Y_N=y_N) &= \Pi_{i=1}^N P(Y_i = y_i) \nonumber \\
                              &= \Pi_{i=1}^N p_i^{y_i} \times (1-p_i)^{1-y_i} \nonumber \\
\end{align}
