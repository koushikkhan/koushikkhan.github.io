...
Note that, putting $y=1$ in the above function will give you $p$. This function always gives a value in between zero and one. It is also known as the *likelihood function* given that the quantity $p$ is unknown.
